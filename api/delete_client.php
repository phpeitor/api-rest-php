<?php
    ...
    if (isset($headers['Authorization']) && $headers['Authorization'] === "Bearer $static_token") {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'DELETE' && strpos($_SERVER['CONTENT_TYPE'], 'application/json') === 0) {
            ...
            header('Content-Type: application/json; charset=utf-8');
            http_response_code(400);
            echo json_encode(array('message' => 'La solicitud debe ser DELETE y tener el tipo de contenido application/json'));
        }
